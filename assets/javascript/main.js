...
const app = {
    ...
    songsData : [
        {
            background: './assets/img/songs/0.jpg',
            name: 'Ma Sói',
            singer: 'CARA',
        ...
        {
            background: './assets/img/songs/1.jpg',
            name: 'Nếu Em Còn Đợi Anh',
            singer: 'buitruonglinh',
            pathSong: './assets/music/list-song/1.mp3',
            duration : '03:53',
        },
        {
            background: './assets/img/songs/2.jpg',
            name: 'Hồi Kết (Lofi Version)',
            singer: 'Hà Nhi',
        ...
        {
            background: './assets/img/songs/4.jpg',
        ...
        },
        {
            ...
            name: 'Mash Up: Ánh Sáng Của Đời Tôi',
            singer: 'Tóc Tiên',
        ...
        },
        {
            ...
            name: 'Chiếc Lá Mùa Đông (Live in Giao Lộ Thời Gian)',
            singer: 'Vicky Nhung',
        ...
        },
        {
            ...
            name: 'Anh Tự Do Nhưng Cô Đơn (feat. Quân A.P)',
        ...
        },
        {
            ...
            name: 'Mashup Lâu Lâu Nhắc Lại x Ngày Nào Đó',
            singer: 'Hà Nhi, Trung Quân',
        ...
        },
        {
            ...
            name: 'Ngày Chưa Giông Bão (Music Home Mùa 1)',
            singer: 'Phan Mạnh Quỳnh, Bùi Lan Hương',
        ...
        themeItems.forEach((themeItem, index) => {
            themeItem.onclick = function() {
                if (index == 0) {
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.background = 'rgb(23, 15, 35)';
                    $('.main-music-control').style.backgroundImage = '';
                    $('.main-music-control').style.backgroundColor = '#282034';
                    $('.mobile-tab').style.backgroundColor = '#282034';
